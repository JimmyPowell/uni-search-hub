...
#
# create table `uni-search-hub`.tokens
# (
...
#     accessed_time        bigint                   null,
#     expired_time         bigint        default -1 null,
#     remain_quota         bigint        default 0  null,
#     unlimited_quota      tinyint(1)               null,
#     model_limits_enabled tinyint(1)               null,
#     model_limits         varchar(1024) default '' null,
#     allow_ips            varchar(191)  default '' null,
#     used_quota           bigint        default 0  null,
#     `group`              varchar(191)  default '' null,
#     cross_group_retry    tinyint(1)               null,
#     deleted_at           datetime(3)              null,
#     constraint idx_tokens_key
#         unique (`key`)
# );
#
# create index idx_tokens_deleted_at
#     on `new-api`.tokens (deleted_at);
#
# create index idx_tokens_name
#     on `new-api`.tokens (name);
#
# create index idx_tokens_user_id
#     on `new-api`.tokens (user_id);