...
import { HomeOutline, KeyOutline, PersonOutline, PeopleOutline, SettingsOutline, DocumentTextOutline, ServerOutline, ListOutline, CardOutline } from '@vicons/ionicons5'
